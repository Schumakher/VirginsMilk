#
#  Be sure to run `pod spec lint VirginsMilk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "VirginsMilk"
  s.version      = "1.0.1"
  s.summary      = "VirginsMilk is an elegant validator for passwords."
  ...
  s.source       = { :git => "https://github.com/Schumakher/VirginsMilk.git", :tag => "1.0.1" }
